...
describe('FilterByValue', () => {
  ...
  it('Return only road and gravel types', () => {
  ...
  it('Return only green and blue color', () => {
...
describe('FilterByValue', () => {
  ...
  it('Return from 3 to 5 items in stock', () => {
  ...
  it('Return manufactured from 2015 to 2020', () => {
...
describe('MixedFilter', () => {
  ...
  it('Return road bikes which manufactured in 2012', () => {
  ...
  it('Return popular bikes which is 2 in stock', () => {
